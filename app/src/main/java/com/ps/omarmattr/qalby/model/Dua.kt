...
data class Dua(val id: Int, val name: String, val image: Int)
...
fun getListDua() =
    arrayListOf(
        ...
        Dua(10, "Protection Against The Evils of Jinn", R.drawable.dua_protection_against_the_evils_of_jinn),
        ...
        Dua(15, "Seeking Divine Counsel Istikharah", R.drawable.dua_seeking_divine_counsel_for_istikharah),
        Dua(16, "Supplications For Healing", R.drawable.dua_supplications_for_healing),
        Dua(17, "Supplications For Visiting The Sick", R.drawable.dua_supplications_for_visiting_the_sick),
        Dua(18, "Seeing Someone in Illness or Trial", R.drawable.dua_seeing_someone_in_ilness_of_trial),
